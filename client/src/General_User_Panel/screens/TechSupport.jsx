...
const TechSupport = () => {
  ...
  return (
    ...
    <div className="mt-16 mx-auto faq-body gap-x-8 h-[auto] flex flex-col items-center justify-center px-4 md:px-0 md:gap-x-16 w-full pb-12">
      <img src="../img/techsupport.jpg" className="mt-8 h-[300px] mb-8 object-contain" alt="" />
        <div className='container'>
          <div>
            { userInfo ?
                <Link className="cursor-pointer flex justify-center items-center font-medium rounded-md border bg-[#0C6980] text-white hover:bg-[#084352] hover:text-white text-xs mx-auto py-2 px-3 mb-6 w-1/4  md:py-2 md:px-6 md:text-sm" to="/create-post">Ask a question</Link>  : 
            ...
            {postsList && postsList.map( (post)=> (
              <div key={post._id}>
                ...
                <div className="post-card" key={post._id}>
                    ...
                    <div>
                      <div className='post-card-title'> {post.title}
                ...
                {userInfo && post.author && userInfo._id!==post.author._id && post._id===selectedPostId && 
                  (<div className="w-full flex flex-wrap mt-6 mb-4">
                    <div className="w-full px-3 flex flex-row justify-end">
                      ...
                      <div className='flex flex-row justify-center pl-4 items-center'>
                        {post && <FontAwesomeIcon icon={faPaperPlane} className="text-gray-400 hover:text-gray-600 px-2 cursor-pointer" onClick={() => reply_handler(post._id) }/>}
                      </div>
