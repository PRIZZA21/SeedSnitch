  ...
  return (
    <div>
      <section className="mt-20 gap-x-8 mb-6 h-[auto] md:flex-row px-4 md:px-0 md:gap-x-16 bg-[#f8f8f8] w-full border border-b-slate-200">
        <div className="text-center md:w-1/2 w-full h-full mx-auto flex flex-col items-center justify-start md:py-12">
          <div className="w-full md:w-[800px] text-center p-4 md:p-2">
            <h2 className="md:font-extrabold font-bold text-4xl md:text-5xl pb-2 text-[#242424]">
      ...
      {err ? (
        ...
        <section>
          <div className="min-h-[300px] my-8 w-full md:w-4/6 rounded-lg bg-[#f8f8f8] md:mx-auto shadow-lg flex flex-col">
            <div className="flex-1 border-b-2 px-6 flex flex-row">
              <span className="w-1/4 md:w-1/6 border-r-2 text-sm pt-1 pb-1 md:text-lg">
                Founder
              </span>
              <span className="w-3/4 md:w-5/6 border-l-2 text-sm pt-1 pb-1 pl-3 md:pl-8 md:text-lg">
                {appln.name}
              </span>
            </div>
            <div className="flex-1 border-b-2 px-6 flex flex-row">
              ...
              <span className="w-3/4 md:w-5/6 border-l-2 pt-1 pb-1 pl-3 md:pl-8 md:text-lg">
                {appln.startup_name}
              </span>
            </div>
            <div className="flex-1 border-b-2 px-6 flex flex-row">
            ...
            appln.curr_status === "Applied" && (
              <div className="mx-auto">
                ...
                <div className="flex flex-row gap-8 md:gap-0 md:flex-wrap mx-auto w-1/5 md:w-1/6 justify-around mb-8">
                  <button
                    className="rounded-lg px-4 py-2 bg-green-300 text-black-100 font-bold hover:bg-green-500 duration-300"
                    onClick={acceptHandler}
                  >
                    Accept
                  </button>
                  <button
                    className="rounded-lg px-4 py-2 bg-red-300 text-black-100 font-bold hover:bg-red-500 duration-300"
