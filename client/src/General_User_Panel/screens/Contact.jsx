...
const Contact = () => {
  ...
  useEffect(() => {
    ...
    const url ="https://script.google.com/macros/s/AKfycbyj7EL2tV1oxo9fK9fefAu0EuckxFwwb288r7g_Vy4pO76FB3eysSE7DhivQeh7FkkELA/exec";
      ...
      <div class="flex h-[88vh] w-full">
        <div class="my-auto w-1/2 mx-auto">
            <div class="bg-white p-6 rounded-lg drop-shadow-2xl">
              ...
              <h2 class="text-2xl font-bold mb-2 text-gray-800 text-center">Thanks for contacting</h2>
              <p class="text-gray-700 text-center">We will revert back to you soon</p>
            </div>
        </div>
      </div>)
  }
    ...
    <section className="h-auto py-10 px-2 relative md:mb-20 md:mt-0 mt-10">
      ...
      >
          ...
          >
            <div className="flex flex-wrap -mx-3 mb-6">
              <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input
                  className="appearance-none block w-full bg-gray-100 text-darkBlue border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                  id="grid-first-name"
                  type="text"
                  required
                  name="First Name"
            ...
            <div className="flex flex-wrap -mx-3 mb-2 mt-8">
              <div className="w-full md:w-full px-3 mb-6 md:mb-0">
                ...
                <textarea
                  className="resize-none w-full bg-gray-100 text-darkBlue border border-b-gray-100 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                  id="grid-message"
        ...
        <div className="md:hidden flex flex-col items-center">
          ...
          />
          <div
            className="bg-transparent p-2 flex flex-col justify-center items-start text-left"
          >
            <div>
        ...
        <div
          className="hidden w-1/2 h-full md:flex flex-col items-center justify-center"
        >
          <img
            src="../img/contact.png"
