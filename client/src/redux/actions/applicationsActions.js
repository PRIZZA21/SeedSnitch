...
export const listApplications = (keyword = '',pageNumber = '') => async(dispatch) => {
    ...
    try {
        ...
        const {data}= await axios.get(`http://localhost:4000/api/applications?keyword=${keyword}&pageNumber=${pageNumber}`)
...
export const createApplication = (name,email,startup_name,linkedin_profile,college_name,contact_number,start_up_stage,start_up_description,start_up_problem,start_up_differentiator) => async(dispatch,getState) => {
    ...
    try {
        ...
        const {data}= await axios.post(`http://localhost:4000/api/applications/create`,{name,email,startup_name,linkedin_profile,college_name,contact_number,start_up_stage,start_up_description,start_up_problem,start_up_differentiator},config)
...
export const listUserApplications = (pageNumber = '') => async(dispatch,getState) => {
    ...
    try {
        ...
        const {data}= await axios.get(`http://localhost:4000/api/applications/creator/${userInfo._id}?pageNumber=${pageNumber}`,config)
...
export const listIncubatorApplications = () => async(dispatch,getState) => {
    ...
    try {
        ...
        const {data}= await axios.get(`http://localhost:4000/api/applications/incubator/`,config)
